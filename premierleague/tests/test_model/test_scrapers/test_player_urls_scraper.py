...
async def test_get_club_player_urls():
    ...
    expected_result = [ 
        {"player_name": "JohnDoe", "player_page_url": "https://www.premierleague.com/players/1111/john-doe/overview"},
        {"player_name": "JaneSmith", "player_page_url": "https://www.premierleague.com/players/2222/jane-smith/overview"}
    ]
