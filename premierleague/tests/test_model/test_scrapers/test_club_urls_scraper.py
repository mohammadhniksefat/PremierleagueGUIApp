...
async def test_get_club_urls_return_expected_value(clubs_page_html):
    expected_value = [
        {"club_name": 'Arsenal', "club_page_url": 'https://www.premierleague.com/clubs/1/Arsenal/overview'},
        {"club_name": 'Aston Villa', "club_page_url": 'https://www.premierleague.com/clubs/2/Aston-Villa/overview'}
    ]
